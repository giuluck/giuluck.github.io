function build(language) {
  ...
  return {
    ...
    biography: select(
      `
        <p>
          I am a <strong>Developer</strong> and <strong>Data Scientist</strong> with more than <strong>five years of professional experience</strong>.
        </p>
        <p>
          In 2025, I obtained a <strong>PhD in Computer Science and Engineering</strong> where I worked on <strong>Constrained Machine Learning</strong> applied to Algorithmic Fairness, with a PhD dissertation titled “<a href="https://github.com/giuluck/non-linear-correlations/blob/main/dissertation.pdf" target="_blank">Detection and Enforcement of Non-Linear Correlations for Fair and Robust Machine Learning Applications</a>”, but I also explored other areas of <strong>Artificial Intelligence</strong>, such as <em>Causal Discovery Algorithms</em>, <em>Declarative Business Process Mining</em>, <em>Decision-Focused Learning for Combinatorial Optimization</em>, <em>Prescriptive Modelling for Decision Support Systems</em>, <em>Anomaly Detection in Industrial Machines and Extreme Events</em>, and <em>Music Generation via Constraint Programming</em>.
        </p>
        <p>
      ...
      `
        <p>
          Sono uno <strong>Sviluppatore</strong> e <strong>Data Scientist</strong> con oltre <strong>cinque anni di esperienza professionale</strong>.
        </p>
        <p>
          Nel 2025 ho conseguito un <strong>Dottorato in Ingegneria e Scienze Informatiche</strong> in cui mi sono occupato principalmente di <strong>Machine Learning Vincolato</strong> applicato alla Fairness Algoritmica, con una tesi dal titolo "<a target="_blank" href="https://github.com/giuluck/non-linear-correlations/blob/main/dissertation.pdf" >Detection and Enforcement of Non-Linear Correlations for Fair and Robust Machine Learning Applications</a>", ma ho esplorato anche altri ambiti dell'<strong>Intelligenza Artificiale</strong>, come gli <em>Algoritmi di Causal Discovery</em>, il <em>Business Process Mining Dichiarativo</em>, il <em>Decision-Focused Learning per Ottimizzazione Combinatoria</em>, la <em>Modellazione Prescrittiva per i Sistemi di Supporto alle Decisioni</em>, l'<em>Anomaly Detection in Macchinari Industriali ed Eventi Estremi</em>, e la <em>Generazione di Brani Musicali tramite Constraint Programming</em>.
        </p>
        <p>
    ...
    short_biography: select(
      `
        <p>
          I am a <strong>Data Scientist</strong> and <strong>Software Developer</strong> with more than ten years of experience between education and professional activity. In 2025, I obtained a <strong>PhD in Computer Science and Engineering</strong> where I worked on <strong>Constrained Machine Learning</strong>, as well as exploring other areas of <strong>Artificial Intelligence</strong> such as <em>Causal Discovery</em>, <em>Business Process Mining</em>, <em>Numerical Optimization</em>, <em>Decision Support Systems</em>, and <em>Anomaly Detection</em>.
        </p>
      `,
      `
        <p>
          Sono un <strong>Data Scientist</strong> e <strong>Sviluppatore Informatico</strong> con oltre dieci anni di esperienza fra educazione e attività professionale. Nel 2025 ho conseguito un <strong>Dottorato in Ingegneria e Scienze Informatiche</strong> in cui mi sono occupato di <strong>Machine Learning Vincolato</strong>, oltre a esplorare ambiti dell'<strong>Intelligenza Artificiale</strong> come <em>Causal Discovery</em>, <em>Business Process Mining</em>, <em>Ottimizzazione Numerica</em>, <em>Sistemi di Supporto alle Decisioni</em>, e <em>Anomaly Detection</em>.
        </p>
      `,
    ),
    // SKILLS DATA
    ...
    education: [
      {
        ...
        description: select(
          {
            "Research Instutute": "Institute for Earth System Predictions (IESP)",
            "Research Division": "Regional Ocean Forecasting Systems (ROFS)",
            "Research Unit": "Research to Operations (R2O)",
            Activities: `
              <ul>
                <li>Analysis of the Research and Development Services interfaced with the <a href="https://marine.copernicus.eu/" target="_blank">Copernicus Marine Environment Monitoring Service</a></li>
                <li>Design and Development of Ocean Data Processing, Validation, and Visualization Systems</li>
                <li>Performance Analysis and Optimization of Scientific Software running on High-Performance Computing Systems</li>
              </ul>
            `,
          },
          {
            ...
            Attività: `
              <ul>
                <li>Analisi dell'Utilizzo dei Servizi di Ricerca e Sviluppo interfacciati con il <a href="https://marine.copernicus.eu/it" target="_blank">Copernicus Marine Environment Monitoring Service</a></li>
                <li>Design e Sviluppo di Sistemi per il Processing, la Validazione, e la Visualizzazione di Dati Oceanici</li>
                <li>Analisi delle Performance e Ottimizzazione di Software Scientifico eseguito su Sistemi di High-Performance Computing</li>
              </ul>
            `,
          },
        ),
      ...
      },
      {
        ...
        description: select(
          {
            '<a href="https://www.unibo.it/en/study/course-units-transferable-skills-moocs/course-unit-catalogue/course-unit/2024/446609" target="_blank">Artificial Intelligence in Industry</a>':
              "2021/22, 2022/23, 2023/24, 2024/25.",
            '<a href="https://www.unibo.it/en/study/course-units-transferable-skills-moocs/course-unit-catalogue/course-unit/2024/468002" target="_blank">Fundamentals of Artificial Intelligence (IT)</a>':
              "2024/25.",
            '<a href="https://www.unibo.it/en/study/course-units-transferable-skills-moocs/course-unit-catalogue/course-unit/2023/446566" target="_blank">Fundamentals of Artificial Intelligence (EN)</a>':
              "2022/23, 2023/24.",
            "Coordination and Support to Computer Science Exam Preparation": "2021/22.",
          },
          {
            '<a href="https://www.unibo.it/it/studiare/insegnamenti-competenze-trasversali-moocs/insegnamenti/insegnamento/2024/446609" target="_blank">Artificial Intelligence in Industry</a>':
              "2021/22, 2022/23, 2023/24, 2024/25.",
            '<a href="https://www.unibo.it/it/studiare/insegnamenti-competenze-trasversali-moocs/insegnamenti/insegnamento/2024/468002" target="_blank">Fondamenti di Intelligenza Artificiale</a>':
              "2024/25.",
            '<a href="https://www.unibo.it/it/studiare/insegnamenti-competenze-trasversali-moocs/insegnamenti/insegnamento/2023/446566" target="_blank">Fundamentals of Artificial Intelligence</a>':
              "2022/23, 2023/24.",
      ...
      },
      {
        ...
        link: `https://loccioni.com/${language}`,
        period: "06/2015 - 07/2015",
        description: select(
          {
            Company: "Loccioni Group, Angeli di Rosora (IT).",
            Project:
              "Development of a <i>web application in AngularJS</i> for monitoring the environmental conditions of a workplace.",
          },
          {
            Azienda: "Gruppo Loccioni, Angeli di Rosora (AN)",
            Progetto:
              "Sviluppo di un'<i>applicazione web in AngularJS</i> per il controllo delle condizioni ambientali di un luogo di lavoro.",
          },
        ),
      },
      {
    ...
    projects: [
      ...
      },
      {
        ...
        tagline: select("A Graph-based Simulator for Power Plants", "Un Simulatore di Power Plants basato su Grafi"),
      },
      {
        relevant: false,
